...
public class CWServiceTWS_Tipo1HiloImpl extends Thread  {
    private static final Logger LOG = LogManager.getLogger(CWServiceTWS_Tipo1HiloImpl.class);
        ...
        public CWServiceTWS_Tipo1HiloImpl(com.tws.wsdl.EnquiryInput enquiryInput)  {               
...
//                                    System.out.println(cadenaXml);  
                            ...
                            System.err.println("###########Calling Servicio CWServiceTWS_Tipo1HiloImpl##################  hora: " + new Date() );          
                        } catch (Exception  e) 
                           {
                                LOG.error( "ERROR: " + e.getMessage()); 
                                System.out.println("Error CWServiceTWS_Tipo1HiloImpl 1: " + e.getMessage());
        ...
        public String getResult()
            {
                    ...
                    try {
                        ...
                        {
                            LOG.error( "ERROR: " + e.getMessage()); 
                            System.out.println("resultado CWServiceTWS_Tipo1HiloImpl: " + e.getMessage());
