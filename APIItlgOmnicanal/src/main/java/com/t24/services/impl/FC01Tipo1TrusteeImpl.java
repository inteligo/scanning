...
public class FC01Tipo1TrusteeImpl implements FC01Tipo1Trustee   {  
    private static final Logger LOG = LogManager.getLogger(FC01Tipo1TrusteeImpl.class);
...
//                        org.jdom2.Element head01= rootE01.getChild("head");
                        ...
                        for (org.jdom2.Element element01 : lst01table) {
                            ...
                            if (element01.getAttributeValue("name").equals("CUS.LIST")) {
                                for (org.jdom2.Element element1 : tablee) {
                                    ...
                                    lista.setDirection((String) element1.getChildText("Direction").trim()); 
                                    lista.setFirmaTitular((String) element1.getChildText("FirmaTitular").trim());                                     
                                    lista.setTipoCliente((String) element1.getChildText("TipoCliente").trim()); 
                                    lista.setNombre((String) element1.getChildText("Nombre").trim()); 
                                    lista.setApellidos((String) element1.getChildText("Apellidos").trim()); 
                                    lista.setRazonSocial((String) element1.getChildText("RazonSocial").trim()); 
                                    lista.setSector((String) element1.getChildText("Sector").trim()); 
            ...
            LOG.error( "ERROR: (FC01CUSList) " + e.getMessage());
...
//                    lista.setWorkingBalinUSD(0.00);                  
            ...
            LOG.error( "ERROR: (FC01ACList) " + e.getMessage());
                 System.err.println(e.getMessage()); 
                 FC01_ACLIST lista = new FC01_ACLIST();
                lista.setWorkingBal(0.00);                   
                lista.setAcctBal(0.00);      
...
//                        org.jdom2.Element head01= rootE01.getChild("head");
                        ...
                        for (org.jdom2.Element element01 : lst01table) {
                            ...
                            if (element01.getAttributeValue("name").equalsIgnoreCase("SIGN.LIST")) {
                                for (org.jdom2.Element element1 : tablee) {
                                    ...
                                    lista.setIdClient((String) element1.getChildText("CustomerNo").trim());
                                    ...
                                    lista.setSignDocType((String) element1.getChildText("SignDocType").trim()); 
                                    lista.setSignId((String) element1.getChildText("SignId").trim()); 
            ...
            LOG.error( "ERROR: (FC01SIGNList) " + e.getMessage());
            System.err.println(e.getMessage()); 
            FC01_SIGNLIST lista = new FC01_SIGNLIST();
    ...
    public List<FC01_COLLLIST> FC01COLLList (String xmlString, String CustomerNo) {
       SAXBuilder builder = new SAXBuilder();
        ...
        try {
            ...
            LOG.error( "ERROR: (FC01COLLList) " + e.getMessage());
            System.err.println(e.getMessage()); 
            FC01_COLLLIST lista = new FC01_COLLLIST();
...
//                        org.jdom2.Element head01= rootE01.getChild("head");
            ...
            LOG.error( "ERROR: (FC01LIMITList) " + e.getMessage());
            System.err.println(e.getMessage()); 
            FC01_LIMITLIST lista = new FC01_LIMITLIST();
    ...
    public List FC01List (String xmlString,String CustomerNo,List<dto.sql.Moneda>  listMonedas) {
        ...
        try
        {
           ...
           LOG.error( "ERROR: (FC01List) " + e.getMessage());
        }
        return listaFinal;
    }
    ...
    public List<FC01_SIGNLIST> FC01SIGNListTotal (String xmlString,String CustomerNo,List<dto.sql.Moneda>  listMonedas) {
        List<FC01_SIGNLIST> listaFinal = null;         
        listaFinal = new ArrayList<>();  
    ...
    //        List<FC01_LIMITLIST> lista5 = FC01LIMITList (xmlString,CustomerNo);
            ...
            List<FC01_ACLIST> acListTitular = null;
    //        acListTitular = new ArrayList<>();
    ...
    //            list = FC01ACList(xmlString, customerNo,listMonedas);
          ...
          for (FC01_ACLIST y:acListTitular)
            {
               FC01_SIGNLIST lista = new FC01_SIGNLIST();
               lista.setAccountNo(y.getAccountNo());
               lista.setCustomerNo(y.getAccCustomer());
               lista.setSignRelation("Secundary");
               lista.setSignGroup("GRUPO A");
               lista.setSignCondition("1A");
           ...
           LOG.error( "ERROR: (FC01SIGNListTotal) " + e.getMessage());
        }
    ...
    public List CuentayFirmaList (String xmlString,String CustomerNo,List<dto.sql.Moneda>  listMonedas)  
    {
        ...
        List<FC01_ACLIST> CtaAsociada = null;
        CtaAsociada = new ArrayList<>();
...
//                     // OBTENEMOS LAS CUENTAS TRADING 
                    List<FC01_ACLIST> listTrading = null;
                    listTrading= new ArrayList<>();   
                    listTrading = LisAc.stream().filter(x -> x.getAccountType().trim().equals("Trading Account")).collect(Collectors.toList());
                    
                    // OBTENEMOS LAS CUENTAS CORRIENTES 
                    List<FC01_ACLIST> listCorriente = null;
                    listCorriente= new ArrayList<>();   
                    listCorriente = LisAc.stream().filter(x -> !x.getAccountType().trim().equals("Trading Account")).collect(Collectors.toList());
                    
                    json= gson.toJson(listTrading);
                    System.out.println("listTrading");           
                    System.out.println(json); 

                    json= gson.toJson(listCorriente);
                    System.out.println("listCorriente");           
                    System.out.println(json); 


                    // ENCONTRAMOS LAS CUENTAS ASOCIADAS
                    for (FC01_ACLIST cyf1 : listTrading) 
                     {
                         FC01_ACLIST cuenta = new FC01_ACLIST();               
                         ...
                         if (!cyf1.getAccountAssoc().trim().equals(""))
                            {
                            for (FC01_ACLIST cyf2 : listCorriente) 
                            {                               
                                if (cyf1.getAccountAssoc().trim().equals(cyf2.getAccountNo().trim()))
                                {     
                                    FC01_ACLIST cuentaAsoc = new FC01_ACLIST();            
                                    cuentaAsoc.setIdClient(cyf2.getIdClient());
                                    cuentaAsoc.setAccCustomer(cyf2.getAccCustomer());
                                    cuentaAsoc.setAccountNo(cyf2.getAccountNo());
                                    cuentaAsoc.setAccountActive(cyf2.getAccountActive());
                                    cuentaAsoc.setAccountInactive(cyf2.getAccountInactive());
                                    cuentaAsoc.setAccountType(cyf2.getAccountType());
                                    cuentaAsoc.setAgreementID(cyf2.getAgreementID());
                                    cuentaAsoc.setAccountAssoc(cyf1.getAccountNo());            
                                    cuentaAsoc.setCurrency(cyf2.getCurrency());
                                    cuentaAsoc.setWorkingBal(cyf2.getWorkingBal());
                                    cuentaAsoc.setAcctBal(cyf2.getAcctBal());
                                    cuentaAsoc.setWorkingBalUSD(cyf2.getWorkingBalUSD());
                                    cuentaAsoc.setAcctBalUSD(cyf2.getAcctBalUSD());
                                    cuentaAsoc.setOLBActive(cyf2.getOLBActive());
                                    cuentaAsoc.setLimit(cyf2.getLimit());
                                    cuentaAsoc.setLimitAmount(cyf2.getLimitAmount());
                                    cuentaAsoc.setLimitAmtDisp(cyf2.getLimitAmtDisp());            
                                    cuentaAsoc.setLimitExpDate(cyf2.getLimitExpDate());
                                    cuentaAsoc.setCollateralActive(cyf2.getCollateralActive());
                                    cuentaAsoc.setAccSegment(cyf2.getAccSegment());
                                    cuentaAsoc.setItlgCustType(cyf2.getItlgCustType());
                                    cuentaAsoc.setPortfolio(cyf1.getPortfolio());           
                                    cuentaAsoc.setNombreMoneda(cyf2.getNombreMoneda());
                                    cuentaAsoc.setSimboloMoneda(cyf2.getSimboloMoneda());  
                                    
                                    cuentaAsoc.setErrcod(cyf1.getErrcod()); 
                                    cuentaAsoc.setDetcod(cyf1.getDetcod()); 
                                    cuentaAsoc.setDefcod(cyf1.getDefcod()); 
                                    
                                    CtaAsociada.add(cuentaAsoc);
                         ...
                         CtaAsociada.add(cuenta);
//                         CtaAsociada.add(cuentaAsoc);
                     }
                    
                    
                     json= gson.toJson(CtaAsociada);
                    System.out.println("CtaAsociada");           
                    System.out.println(json); 
                        ...
                        for (FC01_ACLIST x:LisAc)
                            {
                                ...
                                listaaccount.setWorkingBalinUSD(x.getWorkingBalUSD());
                                ...
                                for (FC01_SIGNLIST y:LisSign)
                                {
                                    if(x.getAccountNo().equals(y.getAccountNo()))
                                    {
                                        ...
                                        listaaccount.setSignDocType(y.getSignDocType());
                                        listaaccount.setSignId(y.getSignId());
                     ...
                     for (FCCuentaFirma cyf3 : CuenFirP) 
                     {
                         ...
                         cuenta.setWorkingBalinUSD(cyf3.getWorkingBalinUSD());
                         ...
                         cuenta.setSignDocType(cyf3.getSignDocType());
                         cuenta.setSignId(cyf3.getSignId());
                    ...
                    List<FCCuentaFirma> CtaTrading = null;
                    CtaTrading= new ArrayList<>();   
                    CtaTrading = CuenFirPorta.stream().filter(x -> x.getAccountType().toString().trim().equals("Trading Account")).collect(Collectors.toList());
                    ...
                    for (FCCuentaFirma cyf1 : CuenFirPorta) 
                     {
                         ...
                         cuenta.setAcctBal(cyf1.getAcctBal());
                         cuenta.setWorkingBalUSD(cyf1.getWorkingBalUSD());
                         cuenta.setWorkingBalinUSD(cyf1.getWorkingBalinUSD());
                         cuenta.setAcctBalUSD(cyf1.getAcctBalUSD());
                         cuenta.setOLBActive(cyf1.getOLBActive());
                         cuenta.setLimit(cyf1.getLimit());
                         cuenta.setLimitAmount(cyf1.getLimitAmount());
                         ...
                         cuenta.setSignDocType(cyf1.getSignDocType());
                         cuenta.setSignId(cyf1.getSignId());
                         cuenta.setRelationCode(cyf1.getRelationCode());
                         cuenta.setPortfolio(cyf1.getPortfolio());  
                         cuenta.setIdPortfolio(cyf1.getIdPortfolio());   
                         cuenta.setNombreMoneda(cyf1.getNombreMoneda());
                         cuenta.setSimboloMoneda(cyf1.getSimboloMoneda());
                         for (FCCuentaFirma cyf2 : CtaTrading) 
                         {
