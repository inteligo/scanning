...
import com.t24.services.FC01Tipo1Nuevo;
...
public class FC01Tipo1NuevoImpl implements FC01Tipo1Nuevo   {  
    private static final Logger LOG = LogManager.getLogger(FC01Tipo1NuevoImpl.class);
         ...
         try {
                List<FCReturn> listaRetorno =fcretorno.ListaRetorno(xmlString);       
                   ...
                   if (errcod.equals("0"))
                    ...
                    listTrading = CuenFirPorta.stream().filter(x -> x.getAccountType().toString().trim().equals("Trading Account")).collect(Collectors.toList());
