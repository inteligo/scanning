...
public class CuentaPatrimonioImpl {
    
     private static final Logger LOG = LogManager.getLogger(CuentaPatrimonioImpl.class);
...
//                        lstPrt.setDescPortafolio(cyf.getDescPortafolio());
            ...
            System.out.println(json);            
                ...
                for (FC44_DEPODETS dl1 : DepositoList) 
                {
                    ...
                    deposito.setEstitu(dl1.getEstitu());
                    deposito.setErrcod(dl1.getErrcod());
                    deposito.setDefcod(dl1.getDefcod());
                    deposito.setDetcod(dl1.getDetcod());
                ...
                Integer lvintIndicaDepositosPorta=0; //Si es = no hay datos de depositos si es 1 hay datos de depositos sin portafolio
                Integer lvintIndicaDepositosSinPorta=0; //Si es = no hay datos de depsositos si es 1 hay datos de depositos sin portafolio
...
//                                             String estitu="";
//                                            if (cfp1.getSignRelation().equals("Principal") || cfp1.getSignRelation().equals("Power of Attorney Holder"))
//                                                 {  
//                                                     estitu="T";                                       
//                                                 }
//                                             else if (cfp1.getSignRelation().equals("Secundary"))
//                                                 {                                  
//                                                     estitu="F";                                        
//                                                 }
//                                             else
                        ...
                        for (FCTotalDeposito tport1:TotalDepositoPorta)
                                { 
                                    ...
                                    {  
                                        ...
                                        { 
                                             if (!ldp.getIdClient().equals(""))
                                            {   
                                                if (tport1.getIdPortfolio().equals(ldp.getIdPortafolio()))
                                                {          
                                                lvintIndicaDepositosPorta=1;
                                                ...
                                                JODetDeposPorta.put("estitu", Convierte.NullaVacio(ldp.getEstitu()));
                                                JODetDeposPorta.put("owner", Convierte.NullaVacio(ldp.getCliente()));
...
//                                     String estitu="";
//                                            if (cyfp3.getSignRelation().equals("Principal") || cyfp3.getSignRelation().equals("Power of Attorney Holder"))
//                                                 {  
//                                                     estitu="T";                                       
//                                                 }
//                                             else if (cyfp3.getSignRelation().equals("Secundary"))
//                                                 {                                  
//                                                     estitu="F";                                        
//                                                 }
//                                             else
...
//                                                     estitu="F";
//                                                 }
//                                             JODetSinPorta.put("estitu",estitu); 
                                     JODetSinPorta.put("estitu",Convierte.NullaVacio(cyfp3.getTitular())); 
                                    
                                    JACtaIndep.add(JODetSinPorta); 
                                }  
                                       
                            json= gson.toJson(TotalDepositoSinPorta);
                            System.out.println("TotalDepositoSinPorta");           
                            System.out.println(json); 
                            ...
                            lvintIndicaDepositosSinPorta=0;
                            for (FCDeposito ldp:DepositoPortafolio)
                            { 
                                if (!ldp.getIdClient().equals(""))
                                   {   
                                    if (ldp.getIdPortafolio().equals(""))
                                        {     
                                        lvintIndicaDepositosSinPorta=1;
                                        ...
                                        JODetDeposSinPorta.put("estitu", Convierte.NullaVacio(ldp.getEstitu()));
                                        JODetDeposSinPorta.put("owner", Convierte.NullaVacio(ldp.getCliente()));
                     ...
                     // si no hay datos
                    if (lvintIndicaDepositosSinPorta==0)
                    {
//                        JSONObject JOListCta =new JSONObject();
//                        JSONObject JOListSinPorta =new JSONObject();
                        JSONObject JODeposSinPorta =new JSONObject();
