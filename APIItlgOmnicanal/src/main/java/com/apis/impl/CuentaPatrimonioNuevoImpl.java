...
import com.t24.services.impl.FC53Tipo1NuevoImpl;
...
public class CuentaPatrimonioNuevoImpl {
     private  Logger LOG =LogManager.getLogger(CuentaPatrimonioNuevoImpl.class);
...
//        List  ListaResult= new ArrayList<String>();  
        ...
        FC53Tipo1Nuevo fc53= new FC53Tipo1NuevoImpl();
        ...
        {                          
            ...
            cabecera1=ibaguid.Encabezado(GeneraUUID.CodigoUUID(), Constantes.INTEGRADOR_FC53, CustomerNo,"" );           
            ...
            CWServiceClienteCRMHiloImpl servicio6 = new CWServiceClienteCRMHiloImpl(CustomerNo);  
            ...
            Thread hilo6 = servicio6;
            hilo6.start();

             while (hilo1.isAlive() || hilo2.isAlive() || hilo3.isAlive() || hilo4.isAlive()  || hilo5.isAlive() || hilo6.isAlive())
                {

                    listClienteCRM=servicio6.getResult();     
            ...
            // FIN NUEVO ------ HILOS
             ...
             List<FCCuentaFirma> lstCuentaFirmaPrincipal = null;
             lstCuentaFirmaPrincipal = new ArrayList<>();  
            ...
            for(ClienteCRM lpf1:listClienteCRM) {
                   strTipoPersona=lpf1.getTipopersona();
                }
            
            json= gson.toJson(strTipoPersona);
            System.out.println("strTipoPersona");           
            System.out.println(json); 
             
             
            CuentaFirma =fc53.CuentayFirmaList(strFC_return1,CustomerNo,listMonedas);   
    //                        CuentaFirma =fc53.CuentayFirmaFiltroTyFList(strFC_return1,CustomerNo,listMonedas);   
...
//                TotalDepositoSinPorta = new ArrayList<>();
		...
		Double suma =0.00;				  
                ...
                json= gson.toJson(CuentayFirma);
            System.out.println("CuentayFirmaVer");           
            System.out.println(json); 		
...
//                System.out.println(json); 
                ...
                lstCuentaFirmaPrincipal=CuentaFirmaPrincipal(CuentayFirma,PortafolioList);
                ...
                json= gson.toJson(lstCuentaFirmaPrincipal);
                System.out.println("lstCuentaFirmaPrincipal");           
                System.out.println(json);   
                                ...
                                { 
                                    ...
                                    {  
                                        ...
                                        if (lp1.getIdPortfolio().equals(cfp1.getIdPortfolio()))
                                        {
                                            ...
                                            if (strTipoPersona.equals("CN"))  //cliente es natural
                                               {
//                                                    if (lp1.getIdClient().equals(lp1.getAccCustomer())) // La cuenta pertenece al cliente
//                                                    {
                                                        if (lp1.getItlgCustType()==null || lp1.getItlgCustType()=="" )
//                                                        estitun=Convierte.TrusteeoSignatorie(lp1.getItlgCustType(),cfp1.getRelationCode());
                                                        {
                                                             estitun=Convierte.NullaVacio(cfp1.getTitular());
                                                        }
                                                        else
                                                        {
                                                            estitun=Convierte.TitularoFirmante(cfp1.getRelationCode());
                                                        }
...
//                                                    if (lp1.getIdClient().equals(lp1.getAccCustomer())) // La cuenta pertenece al cliente
//                                                    {
                                                if (cyfp3.getItlgCustType()==null || cyfp3.getItlgCustType()=="" )
//                                                        estitun=Convierte.TrusteeoSignatorie(lp1.getItlgCustType(),cfp1.getRelationCode());
                                                {
                                                     estitun=Convierte.NullaVacio(cyfp3.getTitular());
                                                }
                                                else
                                                {
                                                    estitun=Convierte.TitularoFirmante(cyfp3.getRelationCode());
                                                }
//                                                        if (lp1.getItlgCustType().equals("Trustee"))
//                                                             {  
//                                                                 estitun="T";                                       
...
//                        JADetSinPortaCta.add(JOListSinPorta);  
    ...
    public List CuentaFirmaPrincipal (List<FCCuentaFirma> CuentaFirma,List<FC14_PORTFOLIOLIST> PortafolioList)  
    {
        Gson gson =new GsonBuilder().serializeNulls().create();
        String json="";
        List<FCCuentaFirma> CuentaFirmaPrincipal = null;
        CuentaFirmaPrincipal = new ArrayList<>();                
        ...
        try {
            ...
            for (FCCuentaFirma cyf1 : CuentaFirma) {
                ...
                cuenta.setNombreMoneda(cyf1.getNombreMoneda());
                cuenta.setSimboloMoneda(cyf1.getSimboloMoneda());
                if (!cyf1.getIdPortfolio().equals(""))
                {
                      for (FC14_PORTFOLIOLIST pf1 : PortafolioList) {
                        if (cyf1.getIdPortfolio().equals(pf1.getPortfolioID()))
                        {
                            cuenta.setClientType(pf1.getClientType());
                            break;                            
                        }                       
                    }
                }
                ...
                CuentaFirmaPrincipal.add(cuenta);
            }
        }
        catch (NumberFormatException| NullPointerException e) {            
            LOG.error( "ERROR: (CuentaFirmaPrincipal) " + e.getMessage());      
        }              
        catch (Exception e) {
            LOG.error( "ERROR: (CuentaFirmaPrincipal) " + e.getMessage());            
        }
        return CuentaFirmaPrincipal;
    }
