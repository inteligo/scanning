...
public class PagoTarjetaCreditoImpl {
    
    private static final Logger LOG = LogManager.getLogger(PagoTarjetaCreditoImpl.class);

    
    public  String PagoTarjetaCredito (String guid, String canal,String idclie, String tipotra,String ctaori, String tictaori,String monori,String ctades, String mondes, String monto, String fectra,String tiptar,String taritlg, String flgtit, String flgter) 
    {
