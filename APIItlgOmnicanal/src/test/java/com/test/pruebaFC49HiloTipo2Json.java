...
public class pruebaFC49HiloTipo2Json {
...
//            enquiryInput.getEnquiryInputCollection().addAll(Lista);  
            ...
            CWServiceTWS_Tipo2HiloImpl servicio2 = new CWServiceTWS_Tipo2HiloImpl(Constantes.INTEGRADOR_FC49,enquiryInput); 
            ...
            List<FC49_LOANSIGN> DepositosList=null;               
            DepositosList =fc49.LOANSIGN(resultado,CustomerNo,listMonedas);  
