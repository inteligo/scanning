...
public class RegistrarTransferencia {
    ...
    @XmlElementRef(name = "InputXML", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> inputXML;

    /**
     * Obtiene el valor de la propiedad inputXML.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad inputXML.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
